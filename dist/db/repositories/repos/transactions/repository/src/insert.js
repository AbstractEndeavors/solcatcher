...
export async function insertAndReturnId(params) {
    const res = await this.db.query(QueryRegistry.INSERT_TRANSACTION, [
        params.log_id,
        params.pair_id,
        params.meta_id,
        params.signature,
...
export async function insert(params) {
    const result = await this.db.query(QueryRegistry.INSERT_TRANSACTION, [
        params.log_id,
        params.pair_id,
        params.meta_id,
        params.signature,
 ...
 */
export async function insertOrIgnore(params) {
    const result = await this.db.query(QueryRegistry.INSERT_TRANSACTION, [
        params.log_id,
        params.pair_id,
        params.meta_id,
