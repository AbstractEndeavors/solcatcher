...
// CONTEXT APPLICATORS
// ============================================================
export function applyTradeToContext(ctx, trade) {
...
export function applyCreateToContext(ctx, create) {
    ...
    if (ctx.meta.user_address == null && create.user != null) {
        ctx.meta.user_address = create.user;
        ctx.enrich_fields.meta.push('user_address');
    }
