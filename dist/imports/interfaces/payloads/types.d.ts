import type { MintLike, DataLike, AddressLike, IntLike, SigLike, IdLike, TradePipelineResult, CreatePipelineResult, DecodedTradeEvent, DecodedCreateEvent, LimitLike, BoolLike } from './imports.js';
...
export interface ProcessLogResult {
    trades: Array<{
        decoded: TradePipelineResult | DecodedTradeEvent;
        ctx: CTX;
    }>;
    creates: Array<{
        decoded: CreatePipelineResult | DecodedCreateEvent;
        ctx: CTX;
    }>;
    unknowns: Array<{
        decoded: DataLike;
