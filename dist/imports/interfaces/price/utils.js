 ...
 */
export function calculatePrecisePrice(solAmount, tokenAmount, scale = DEFAULT_PRICE_SCALE) {
 ...
 */
export function toUiAmount(baseUnits, decimals) {
    const divisor = 10n ** BigInt(decimals);
    // Use scaled division for precision
    const scaled = (baseUnits * 1000000n) / divisor;
 ...
 */
export function isSafeForNumber(value) {
