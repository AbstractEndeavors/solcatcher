...
CREATE TABLE IF NOT EXISTS pairs (
  ...
  iclaimed_at TIMESTAMPTZ DEFAULT NULL
  ...
  last_fetch TIMESTAMPTZ NULL DEFAULT NULL,
...
RELEASE_SLOT: `
  UPDATE pairs SET claimed_at = NULL WHERE id = $1
`,

REAP_STALE: `
  UPDATE pairs SET claimed_at = NULL
