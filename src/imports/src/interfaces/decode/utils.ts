...
export function normalizeDecodedData<T extends Record<string, any>>(data: T): T {
 ...
 */
export function heuristicDecodeProgramData(
  base64: string
): DecodedProgramData {
  ...
  try {
    fields.lamports = readU64LE(buf, o); o += 8;
    fields.tokenAmount = readU64LE(buf, o); o += 8;
    fields.creator = readPubkey(buf, o); o += 32;
    fields.mint = readPubkey(buf, o); o += 32;
  } catch {
 ...
 * ────────────────────────────────────────────── */
export class Cursor {
  constructor(readonly b: Buffer, public o = 0) {}
...
export const u8  = (b: Buffer, o: number) => b.readUInt8(o);
export const u64 = (b: Buffer, o: number) => b.readBigUInt64LE(o);
export const i64 = (b: Buffer, o: number) => b.readBigInt64LE(o);

export const pubkey = (b: Buffer, o: number) =>
  bs58.encode(b.subarray(o, o + 32));

export const str = (b: Buffer, o: number) => {
  if (o + 4 > b.length) {
 ...
 */
export function isDecodedResult(x: unknown): x is { 
  name: string; 
  category: string; 
