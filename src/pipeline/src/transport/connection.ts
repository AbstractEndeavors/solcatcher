...
export class ConnectionManager {
  ...
  async connect(): Promise<ChannelModel> {
    if (this.channelModel) return this.channelModel;
  ...
  private scheduleReconnect(): void {
    if (this.reconnectTimeout || this.shuttingDown) return;
  ...
  async getChannel(name: string, prefetch: number): Promise<Channel> {
