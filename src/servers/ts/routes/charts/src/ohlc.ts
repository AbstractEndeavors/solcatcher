// ts-apis/routes/charts/ohlc.ts
// OHLC handler factory - inject your services, get a handler back
...
export function createOHLCHandler(ctx: OHLCRouteContext) {
  return async function handleOHLC(req: {
    params: { pair_id: string },
    query: { interval?: string; highlight_user?: string }
